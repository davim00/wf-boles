			...
			<section class="error-404 not-found">
				...
				<div class="page-content">
					...
					<?php
						...
						if ( wfboles_categorized_blog() ) :
					?>

					<div class="widget widget_categories">
						<h2 class="widget-title"><?php esc_html_e( 'Most Used Categories', 'wfboles' ); ?></h2>
						<ul>
						<?php
					...
					<?php
						...
						$archive_content = '<p>' . sprintf( esc_html__( 'Try looking in the monthly archives. %1$s', 'wfboles' ), convert_smilies( ':)' ) ) . '</p>';
