...
<form role="search" method="get" class="form-search form-inline" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<div class="form-group">
	  <label class="sr-only" for="searchText"><?php _e( 'Search', 'wfboles' ); ?></label>
	  <input type="text" class="form-control search-query" placeholder="<?php echo esc_attr_x( 'Search', 'placeholder', 'wfboles' ); ?>" value="<?php echo get_search_query(); ?>" name="searchText" title="<?php echo esc_attr_x( 'Search', 'label', 'wfboles' ); ?>" />
	</div>
